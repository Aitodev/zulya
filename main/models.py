...
class Product(models.Model):
    ...
    img3 = models.ImageField(verbose_name='Изображение 3', upload_to='media/products')
    img4 = models.ImageField(verbose_name='Изображение 4', upload_to='media/products')
    img5 = models.ImageField(verbose_name='Изображение 5', upload_to='media/products')
    img6 = models.ImageField(verbose_name='Изображение 6', upload_to='media/products')
    img7 = models.ImageField(verbose_name='Изображение 7', upload_to='media/products')
